...
public class SalaController {
    ...
    @PostMapping
    public ResponseEntity<SalaResponseDTO> criar(@Parameter(description = "Dados da nova sala") @RequestBody @Valid SalaRequestDTO dto){
    ...
    @PutMapping("/{id}")
    public ResponseEntity<SalaResponseDTO> atualizar(@Parameter(description = "ID da sala a ser atualizada")  @PathVariable int id, @Parameter(description = "Novos dados da sala")  @RequestBody @Valid SalaRequestDTO dto) {
